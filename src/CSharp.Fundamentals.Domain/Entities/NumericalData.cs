namespace CSharp.Fundamentals.Domain.Entities
{
    public class NumericalData
    {
        ...
        public NumericalData(sbyte smallValue, byte byteValue, short shortValue, ushort ushortValue, int intValue, uint uintValue, long longValue, ulong ulongValue, float floatValue, double doubleValue, decimal decimalValue)
        {
            Id = Guid.NewGuid();
